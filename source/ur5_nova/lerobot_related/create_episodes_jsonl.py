...
for i, file in enumerate(onlyfiles):
    ...
    total_length += len(df)  # Add to total length
...
# Print total number of episodes and total length
print(f"Total number of episodes collected: {len(jsonl_data)}")
print(f"Total length (sum of all episode lengths): {total_length}")
